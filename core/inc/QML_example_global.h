...
#include <chrono>
// Params
// <LIBRARY NAME SHORT>=QML 
//
#ifndef BUILD_STATIC
	//#pragma message("QML_EXAMPLE_LIB is a shared library")
	#if defined(QML_EXAMPLE_LIB)
		#define QML_EXAMPLE_EXPORT __declspec(dllexport)
	#else
		#define QML_EXAMPLE_EXPORT __declspec(dllimport)
	#endif
#else 
	//#pragma message("QML_EXAMPLE_LIB is a static library")
	#define QML_EXAMPLE_EXPORT
#endif
